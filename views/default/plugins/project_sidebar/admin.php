...
<div class="sidebarBox">
	...
	<div class="contentWrapper">
		<ul class="plugins_menu">
			<li><a href="<?php echo $vars['url']; ?>plugins/new/release/<?php echo $project->guid; ?>">Upload New Release</a></li>
			<li><a href="<?php echo $vars['url']; ?>plugins/edit/project/<?php echo $project->guid; ?>">Edit Project Details</a></li>
