...
<?php
    ...
    foreach ($sort_fields as $sort_field) {
        ...
        if ($sort_field == $sort) {
            if ($direction == 'asc') {
                $sort_arrow = '<img src="' . $CONFIG->wwwroot. 'mod/community_plugins/_graphics/up_arrow.png" title="Ascending" alt="Ascending"></img>';
            } else {
                $sort_arrow = '<img src="' . $CONFIG->wwwroot. 'mod/community_plugins/_graphics/down_arrow.png" title="Descending" alt="Descending"></img>';
            }
        }
?>
