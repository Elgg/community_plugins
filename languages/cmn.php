...
return array(
	...
	'admin:community_plugins:statistics' => '統計',
	'admin:community_plugins:upgrade' => '升級',
	'admin:community_plugins:utilities' => '公用程式',
	...
	'plugins:gallery' => "圖片集檢視",
	'plugins:gallery_list' => "圖片集或列表檢視",
	...
	'plugins:type:plugin' => '外掛程式',
	'plugins:type:theme' => '主題',
	...
	'plugins:tabs:stats' => '統計',
	'plugins:tabs:upgrade' => '升級',
	'plugins:tabs:utilities' => '公用程式',
...
%s",
	...
	'plugins:sort:title' => '標題',
	'plugins:sort:author' => '作者',
	...
	'plugins:filters:version' => 'Elgg 版本',
...
general project details, visit the edit section of the project page.',
	...
	'plugins:action:invalid_user' => "無效的使用者",
