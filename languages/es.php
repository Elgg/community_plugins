...
return array(
	...
	'admin:community_plugins' => 'Repositorio de Plugins',
	'admin:community_plugins:statistics' => 'Estad&iacute;sticas',
	'admin:community_plugins:upgrade' => 'Actualizar',
	'admin:community_plugins:utilities' => 'Utilidades',
	'admin:settings:community_plugins' => 'Repositorio de Plugins',
	...
	'plugins:new' => "Plugin nuevo",

	'plugins:types:' => "Paquete de plugins, temas y lenguaje",
	'plugins:types:plugin' => "plugins",
	'plugins:types:theme' => "Temas",
	'plugins:types:languagepack' => "Paquete de lenguaje",

	'plugins:yours' => "Su %s",
	'plugins:user' => "%s tiene %s",

	'plugins:admin' => "Administración del repositorio de plugins",
	'plugins:admin:menu' => "Administrador del Reporsitorio de plugins",

	'plugins:yours:friends' => "Los plugins, temas y paquetes de idiomas de tus amigos",
	'plugins:friends' => "Los plugins, temas y paquetes de idiomas de los amigos de %s",
	'plugins:all' => "Todos los plugins, temas y paquetes de idiomas",
	'plugins:category:title' => "Plugins para la categoría: %s",
	'plugins:search:title' => "B&uacute;squeda en plugins de \"%s\" en la categoria: %s",


	'plugins:cat:all' => 'Todos',

	'plugins:listing:newest' => 'M&aacute;s nuevo',
	'plugins:listing:popular' => 'Más descargado',
	'plugins:listing:dugg' => 'Más recomendado',


	'plugins:upload:new' => "Subir un plugin nuevo",


	'plugins:search:instruct' => 'Búsqueda de plugins',
	'plugins:search:choose' => 'elige una categoría',


	'plugins:front:welcome' => "Bienvenido al directorio de plugins de Elgg",
	'plugins:front:intro:title' => "¿Qu&eacute; son los plugins?",
	...
	'plugins:more' => "mas plugins, temas y paquetes de idioma",
	'plugins:list' => "Listar archivos",
	'plugins:group' => "Agrupar  plugins, temas y paquetes de idioma",
	'plugins:gallery' => "vista de galer&iacute;a",
	'plugins:gallery_list' => "Galer&iacute;a o vista de lista",
	'plugins:num_files' => "N&uacute;mero de plugins, temas y paquetes de idioma a mostrar",
	'plugins:yes' => 'Si',
	'plugins:no' => 'No',
	'plugins:num_plugins and themes' => "N&uacute;mero de plugins, temas y paquetes de idioma a mostrar",

	'plugins:new:project' => "Subir un plugin nuevo",
	'plugins:new:release' => "Subir una nueva versi&oacute;n",

	'plugins:edit' => "Editar",
	'plugins:edit:project' => "Editar los detalles del proyecto",
	'plugins:edit:release' => "Editar la versi&oacute;n del plugin",
	...
	'plugins:elggversion' => "Version(es) de Elgg en el que este plugin ha sido probado",
	'plugins:elgg_version' => "Versi&oacute;n de Elgg",
	'plugins:version' => "Versi&oacute;n de plugin",
	'plugins:updated' => "Actualizado",
	'plugins:repo' => "Repositorio de c&oacute;digo",
	'plugins:homepage' => "P&aacute;gina del Plugin/Proyecto",
	'plugins:category' => "Categoria",
	'plugins:categories' => "Categor&iacute;as",
	'plugins:myplugins' => "Sus plugins",
	'plugins:All' => "Todo",
	'plugins:file' => 'Archivo a subir',
	'plugins:donate' => 'Donaciones',
	'plugins:file:uploadagain' => 'Subir una nueva versi&oacute;n',
	'plugins:version' => 'Versi&oacute;n de plugin',
	'plugins:downloads' => "Descargas",
	'plugins:recommendations' => "Recommendations",
	'plugins:upload' => "Subir un nuevo plugin, tema o paquete de idioma",
	'plugins:changelog' => "Bit&aacute;cora de cambios",
	'plugins:noproject' => "Lamentablemente el sistema no pudo encontrar el proyecto del plugin que quizo actualizar",
	'plugins:plugin or theme' => "Archivo",
	'plugins:updated' => "Actualizado",
	'plugins:update' => "Suba una nueva versi&oacute;n de este plugin",
	'plugins:title' => "T&iacute;tulo",
	'plugins:desc' => "Descripci&oacute;n completa",
	'plugins:tags' => "Tags",
	'plugins:notfound' => "The requested plugin cannot be found, please try a search",

	'plugins:plugin_type' => 'Tipo de plugin?',
	'plugins:plugin' => 'Plugin',
	'plugins:theme' => 'Tema',
	'plugins:languagepack' => 'Paquete de idioma',

	'plugins:user:plugin' => "Ver los plugins de %s",
	'plugins:user:theme' => "Ver los temas de %s",
	'plugins:user:languagepack' => "Ver los paquetes de idioma de %s",

	'plugins:types' => "Tipos de plugins, temas y paquetes de idioma subidos",

	'plugins:type:all' => "Plugins de Elgg",
	'plugins:type:plugin' => 'Plugins',
	'plugins:type:theme' => 'Temas',
	'plugins:type:languagepack' => 'Paquetes de idiomas',
	'plugins:user:type:languagepack' => "paquetes de idiomas de %s",
	'plugins:user:type:general' => "Plugins y temas generales de %s",
	'plugins:widget' => "Plugin widget",
	'plugins:widget:description' => "Mostrar tus plugins, temas y paquetes de idioma",

	'plugins:download' => "Descargar",

	'plugins:delete_release:confirm' => "Seguro que quiere borrar esta versi&oacute;n?",
	'plugins:delete_project:confirm' => 'Este proyecto y todas sus versiones sera eliminadas. Esta seguro que quiere borrar este proyecto?',
	'plugins:delete_project_image:confirm' => 'Borrar imagen?',
	'plugins:tagcloud' => "Nube de etiquetas",
	'plugins:diggit' => "Usted ha recomendado este plugin",
	'plugins:display:number' => "N&uacute;mero de plugins, temas y paquetes de idioma a mostrar",

	'plugins:files:acceptable' => 'Distribution packages must be .zip or .tar.zip only.',

	'item:object:plugin_project' => 'Proyectos de Plugins',
	'item:object:plugin_release' => 'Versiones de Plugins',
	'item:object:file' => 'Pantallas de Plugins',

	'plugins:tabs:stats' => 'Estad&iacute;sticas',
	'plugins:tabs:upgrade' => 'Actualizaciones',
	'plugins:tabs:utilities' => 'Utilidades',
	'plugins:tabs:search' => 'Par&aacute;metros de B&uacute;squeda',
...
%s",
	...
	'plugins:filters:version' => 'Versi&oacute;n de Elgg',
...
general project details, visit the edit section of the project page.',
	...
	'plugins:action:invalid_user' => "Usuario inválido",
