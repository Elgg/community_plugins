...
return array(
	...
	'admin:community_plugins:statistics' => 'Estatísticas',
	'admin:community_plugins:upgrade' => 'Atualizar',
	...
	'plugins' => "Administrar ferramentas",
	'pluginss' => "Administrar ferramentas",
	...
	'plugins:listing:newest' => 'Mais recente',
	...
	'plugins:list' => "Visualizar em lista",
	'plugins:group' => "Group plugins, themes and language packs",
	'plugins:gallery' => "Visualizar em galeria",
	'plugins:gallery_list' => "Visualizar em lista ou galeria",
	...
	'plugins:elgg_version' => "Versão do Elgg",
	...
	'plugins:plugin or theme' => "Arquivo",
	'plugins:updated' => "Updated",
	'plugins:update' => "Upload a new version of this plugin",
	'plugins:title' => "Título",
	'plugins:desc' => "Descrição",
	'plugins:tags' => "Tags",
	...
	'plugins:type:plugin' => 'Administrar ferramentas',
	...
	'plugins:tagcloud' => "Nuvem de etiquetas",
	...
	'plugins:tabs:stats' => 'Estatísticas',
	'plugins:tabs:upgrade' => 'Atualizacoes',
...
%s",
	...
	'plugins:filters:version' => 'Versão do Elgg',
	'plugins:filters:licence' => 'Licence type',
	'plugins:filters:text' => 'Any text',
	'plugins:filters:screenshot:label' => 'Captura de tela',
...
general project details, visit the edit section of the project page.',
	...
	'plugins:action:invalid_user' => "Usuario invalido",
