...
return array(
	...
	'admin:community_plugins:statistics' => 'Statistieken',
	'admin:community_plugins:upgrade' => 'Upgrade',
	'admin:community_plugins:utilities' => 'Hulpmiddelen',
	...
	'plugins:new' => "Nieuwe plugin",

	'plugins:types:' => "plugins, thema's en taalpaketten ",
	'plugins:types:plugin' => "plugins",
	'plugins:types:theme' => "thema's",
	'plugins:types:languagepack' => "taalpakketten",

	'plugins:yours' => "Jouw %s",
	'plugins:user' => "%s's %s",

	'plugins:admin' => "Plugin repository administratie",
	'plugins:admin:menu' => "Plugin Repo Admin",

	'plugins:yours:friends' => "Plugins, thema's en taalpakketten van je vrienden",
	'plugins:friends' => "Plugins, thema's en taalpakketten van vrienden van %s",
	'plugins:all' => "Alle site plugins, thema's en taalpakketten",
	'plugins:category:title' => "Plugins in de categorie: %s",
	'plugins:search:title' => "Plugin zoekopdracht op \"%s\" in de categorie: %s",


	'plugins:cat:all' => 'Alle',

	'plugins:listing:newest' => 'Nieuwste',
	'plugins:listing:popular' => 'Meest gedownloade',
	'plugins:listing:dugg' => 'Meest aangeraden',


	'plugins:upload:new' => "Laad een nieuwe plugin op",


	'plugins:search:instruct' => 'zoek naar plugins',
	'plugins:search:choose' => 'Kies een categorie',


	'plugins:front:welcome' => "Welcome to Elgg's plugin directory",
	'plugins:front:intro:title' => "Wat zijn plugins?",
	'plugins:front:intro:text' => "Plugins breiden de mogelijkheden van je Elgg site uit door het toevoegen van functionaliteiten, talen en thema's. Het zijn bijdragen van de Elgg community.

		Om te beginnen kan je alle beschikbare plugins bekijken, zoeken achter een specifieke plugin, er zelf één opladen of reacties en scores geven aan plugins van anderen.",




	'plugins:more' => "meer plugins, thema's en taalpakketten",
	'plugins:list' => "lijst weergave",
	'plugins:group' => "Plugins, thema's en taalpakketten van groepen",
	'plugins:gallery' => "galerij weergave",
	'plugins:gallery_list' => "galerij of lijst weergave",
	'plugins:num_files' => "Aantal plugins, thema's en taalpakketten om weer te geven",
	'plugins:yes' => 'Ja',
	'plugins:no' => 'Nee',
	'plugins:num_plugins and themes' => "Aantal plugins, thema's en taalpakketten om weer te geven",

	'plugins:new:project' => "Laad een nieuwe plugin op",
	'plugins:new:release' => "Laad een nieuwe versie op",

	'plugins:edit' => "Bewerk",
	'plugins:edit:project' => "Bewerk de project details",
	'plugins:edit:release' => "Bewerk de plugin versie",
	...
	'plugins:elggversion' => "Elgg versies waar deze plugin op getest is",
	'plugins:elgg_version' => "Elgg versie",
	'plugins:version' => "Plugin versie",
	'plugins:updated' => "Geüpdatet ",
	'plugins:repo' => "Code repository",
	'plugins:homepage' => "Plugin/project homepage",
	'plugins:category' => "Categorie",
	'plugins:categories' => "Categorieën",
	'plugins:myplugins' => "Jouw plugins",
	'plugins:All' => "Alle",
	'plugins:file' => 'Bestand om op te laden',
	'plugins:donate' => 'Donaties',
	'plugins:file:uploadagain' => 'Laad een nieuwe versie op',
	'plugins:version' => 'Plugin versie',
	'plugins:downloads' => "Downloads",
	'plugins:recommendations' => "Recommendations",
	'plugins:upload' => "Laad een nieuwe plugin, thema of taalpakket op",
	'plugins:changelog' => "Changelog",
	'plugins:noproject' => "Ik ben bang dat het systeem het plugin project dat je wilde updaten niet kon vinden",
	'plugins:plugin or theme' => "Bestand",
	'plugins:updated' => "Geüpdatet ",
	'plugins:update' => "Laad een nieuwe versie op van deze plugin",
	'plugins:title' => "Titel",
	'plugins:desc' => "Omschrijving",
	'plugins:tags' => "Tags",
	'plugins:notfound' => "The requested plugin cannot be found, please try a search",

	'plugins:plugin_type' => 'Type van de plugin?',
	'plugins:plugin' => 'Plugin',
	'plugins:theme' => 'Thema',
	'plugins:languagepack' => 'Taalpakket',

	'plugins:user:plugin' => "Bekijk plugins van %s",
	'plugins:user:theme' => "Bekijk thema's van %s",
	'plugins:user:languagepack' => "Bekijk taalpakketten van %s",
	...
	'plugins:display:number' => "Aantal plugins, thema's en taalpakketten om weer te geven",
	...
	'plugins:tabs:stats' => 'Statistieken',
	'plugins:tabs:upgrade' => 'Upgrades',
	'plugins:tabs:utilities' => 'Hulpmiddelen',
...
%s",
	...
	'plugins:sort:updated' => 'Geüpdatet ',
	...
	'plugins:filters:category' => 'Categorie',
	'plugins:filters:version' => 'Elgg versie',
...
general project details, visit the edit section of the project page.',
	...
	'plugins:action:invalid_user' => "Ongeldige gebruiker",
