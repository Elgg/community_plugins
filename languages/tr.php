...
return array(
	...
	'admin:community_plugins:statistics' => 'İstatistikler',
	'admin:community_plugins:upgrade' => 'Yükselt',
	...
	'plugins:admin:trends:single' => "%s için istatistikler",
	'plugins:admin:trends:all' => "Tüm eklentiler için istatistikler",
	...
	'plugins:new' => "Yeni eklenti",

	'plugins:types:' => "eklentiler, temalar ve dil paketleri",
	'plugins:types:plugin' => "eklentiler",
	'plugins:types:theme' => "temalar",
	'plugins:types:languagepack' => "dil paketleri",
	...
	'plugins:cat:all' => 'Tümü',

	'plugins:listing:newest' => 'En yeni',
	'plugins:listing:popular' => 'En çok indirilen',
	'plugins:listing:dugg' => 'En çok tavsiye edilen',


	'plugins:upload:new' => "Yeni bir eklenti yükle",


	'plugins:search:instruct' => 'eklenti ara',
	'plugins:search:choose' => 'bir kategori seçin',
	...
	'plugins:list' => "liste görünümü",
	'plugins:group' => "Group plugins, themes and language packs",
	'plugins:gallery' => "galeri görünümü",
	'plugins:gallery_list' => "Galeri ya da liste görünümü",
	...
	'plugins:type:all' => "Elgg eklentileri",
	'plugins:type:plugin' => 'Eklentiler',
	'plugins:type:theme' => 'Temalar',
	'plugins:type:languagepack' => 'Dil paketleri',
	...
	'plugins:download' => "İndir",

	'plugins:delete_release:confirm' => "Bu sürümü silmek istediğinize emin misiniz?",
	...
	'plugins:delete_project_image:confirm' => 'Görsel silinsin mi?',
	'plugins:tagcloud' => "Etiket bulutu",
	...
	'item:object:plugin_project' => 'Eklenti Projeleri',
	'item:object:plugin_release' => 'Plugin Releases',
	'item:object:file' => 'Eklenti Ekran Görüntüleri',

	'plugins:tabs:stats' => 'İstatistikler',
	'plugins:tabs:upgrade' => 'Yükseltmeler',
...
<ul>
	...
	'plugins:new:plugin' => "Yeni Eklenti",
...
%s",
	...
	'license:gpl2' => 'GNU Genel Halk Lisansı (GPL) sürüm 2',
	'license:gpl3' => 'GNU Genel Halk Lisansı (GPL) sürüm 3',
	...
	'license:apache' => 'Apache Lisansı, Sürüm 2.0',
	...
	'license:freebsd' => 'FreeBSD lisansı',
	'license:freetype' => 'Freetype Project License',
	'license:jpeg' => 'Independent JPEG Group License',
	'license:intel' => 'Intel Açık Kaynak Lisansı',
	'license:openbsd' => 'ISC (OpenBSD) Lisansı',
	'license:ncsa' => 'NCSA/Illinois Üniversitesi Açık Kaynak Lisansı',
	...
	'plugins:project:deleted' => "Eklenti silindi.",
	...
	'plugins:stats' => "İndirme istatistikleri",
	...
	'plugins:prevversions' => "Önceki sürüm",
	...
	'plugins:sort:title' => 'Başlık',
	'plugins:sort:author' => 'Yazar',
	'plugins:sort:downloads' => 'İndirmeler',
	'plugins:sort:recommendations' => 'Öneriler',
	'plugins:sort:created' => 'Created',
	'plugins:sort:updated' => 'Güncellendi',
	...
	'plugins:filters:category' => 'Kategori',
	'plugins:filters:version' => 'Elgg sürümü',
	'plugins:filters:licence' => 'Licence type',
	'plugins:filters:text' => 'Any text',
	'plugins:filters:screenshot:label' => 'Ekran Görüntüsü',
...
general project details, visit the edit section of the project page.',
	...
	'plugins:edit:label:release_notes' => "Sürüm Notları",
	...
	'plugins:action:invalid_project' => 'Geçersiz Proje',
	...
	'plugins:action:invalid_user' => "Geçersiz kullanıcı",
