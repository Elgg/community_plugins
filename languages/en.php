<?php
	...
	$english = array(
		 ...
		 */
			...
			'plugins:yours' => "Your plugins, themes and language packs",
			'plugins:yours:friends' => "Your friends' plugins, themes and language packs",
			'plugins:user' => "%s's plugins, themes and language packs",
			...
			'item:object:plugin_file' => 'Plugin',
			...
			'plugins:donate' => 'Donate to this plugin',
